...
namespace BuberSinner.Infrastructure.Migrations
{
    ...
    [Migration("20240130130453_InitialCreate")]
            ...
            modelBuilder.Entity("BuberDinner.Domain.Menu.Menu", b =>
                {
                    ...
                    b.OwnsOne("BuberDinner.Domain.Menu.Entities.AveregeRating", "AverageRating", b1 =>
                        {
                            b1.Property<Guid>("MenuId")
                                .HasColumnType("TEXT");
                    ...
                    b.OwnsMany("BuberDinner.Domain.MenuReview.ValueObjects.MenuReviewId", "MenuReviewId", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("INTEGER");
